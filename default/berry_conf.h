...
#else
#define BE_INTGER_TYPE                  1           // use long int = uint32_t (emulator matches Tasmota)
#endif
...
#define BE_USE_COMPACT_KTAB             0           // not needed for emulator, ESP32 flash optimization
#endif
...
#define BE_USE_COMPACT_MAP              0           // not needed for emulator, ESP32 flash optimization
#endif
...
#else
#define BE_USE_PREPROCESSOR             0   /* Berry preprocessor disabled for emulator */
#endif
